        ...
        <div class="container py-5">
            ...
            <div class="row mb-4">
                <div class="col-lg-8 mx-auto text-center">
                    <h1 class="display-6">Thanh toán đơn đặt hàng</h1>
                </div>
            </div>
            <!-- End -->
            <div class="row pb-5">
                        ...
                        <div class="card-header">
                            <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                                ...
                                <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                                    ...
                                    <li class="nav-item"><a data-toggle="pill" href="#paypal" class="nav-link "><i class="fa fa-money mr-2"></i>Thanh toán khi giao hàng </a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="credit-card" class="tab-pane fade show active pt-3">
                                    <div role="form">
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvName" runat="server" ErrorMessage="Tên là bắt buộc"
                                            ...
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                                                ErrorMessage="Tên phải bằng ký tự" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"
                                                ValidationExpression="^[a-zA-Z\s]+$" ControlToValidate="txtName" ValidationGroup="card">*
                                            </asp:RegularExpressionValidator>
                                            <asp:TextBox ID="txtName" runat="server" CssClass="form-control" placeholder="Tên chủ thể"></asp:TextBox>
                                        </div>
                                        <div class="form-group">
                                            <label for="txtCardNo">
                                                <h6>Số thẻ</h6>
                                            </label>
                                            <asp:RequiredFieldValidator ID="rfvCardNo" runat="server" ErrorMessage="Số thẻ là bắt buộc"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <div class="form-group">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="rfvExpMonth" runat="server" ErrorMessage="Tháng hết hạn là bắt buộc"
                                                        ControlToValidate="txtExpMonth" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"
                                                        ValidationGroup="card">*</asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" Display="Dynamic"
                                                        ErrorMessage="Tháng hết hạn phải có 2 chữ số" ForeColor="Red" SetFocusOnError="true"
                                                        ValidationExpression="[0-9]{2}" ControlToValidate="txtExpMonth" ValidationGroup="card">*
                                                    </asp:RegularExpressionValidator>
                                                    <asp:RequiredFieldValidator ID="rfvExpYear" runat="server" ErrorMessage="Năm hết hạn là bắt buộc"
                                                        ControlToValidate="txtExpYear" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"
                                                        ValidationGroup="card">*</asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" Display="Dynamic"
                                                        ErrorMessage="Năm hết hạn phải có 4 chữ số" ForeColor="Red" SetFocusOnError="true"
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group mb-4">
                                                    <label data-toggle="tooltip" title="Mã CVV gồm ba chữ số ở mặt sau thẻ của bạn">
                                                        <h6>CVV <i class="fa fa-question-circle d-inline"></i></h6>
                                                    </label>
                                                    <asp:RequiredFieldValidator ID="rfvCvv" runat="server" ErrorMessage="số CVV bắt buộc"
                                                        ControlToValidate="txtCvv" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"
                                                        ValidationGroup="card">*</asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" Display="Dynamic"
                                                        ErrorMessage="số CVV phải có 3 chữ số" ForeColor="Red" SetFocusOnError="true"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvAddress" runat="server" ErrorMessage="Địa chỉ là bắt buộc" ForeColor="Red"
                                        ...
                                        <div class="card-footer">
                                            <asp:LinkButton ID="lbCardSubmit" runat="server" CssClass="subscribe btn btn-info btn-block shadow-sm"
                                                ValidationGroup="card" OnClick="lbCardSubmit_Click">Xác nhận</asp:LinkButton>
                                ...
                                <div id="paypal" class="tab-pane fade pt-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvCODAddress" runat="server" ErrorMessage="Địa chỉ là bắt buộc" ForeColor="Red"
                                    ...
                                    <p>
                                        <asp:LinkButton ID="lbCodSubmit" runat="server" CssClass="btn btn-info" ValidationGroup="cod" OnClick="lbCodSubmit_Click"
                                            ><i class="fa fa-cart-arrow-down mr-2"></i>Xác nhận</asp:LinkButton>
                                        
                                    </p>
                                    <p class="text-muted">
                                        Lưu ý: Khi nhận hàng quý khách phải thanh toán đầy đủ.
Sau khi hoàn tất quá trình thanh toán, bạn có thể kiểm tra trạng thái đơn hàng đã cập nhật của mình.
                        ...
                        <div class="card-footer">
                            <b class="badge badge-success badge-pill shadow-sm">Tổng Giá: <% Response.Write(Session["grandTotalPrice"]); %> đ</b>
                            <div class="pt-1">
                                <asp:ValidationSummary ID="ValidationSummary1" runat="server" ForeColor="Red" ValidationGroup="card"
                                    HeaderText="Sửa các lỗi sau" Font-Names="Segoe Script" />
                            </div>
                        </div>
                    </div>
                </div>
