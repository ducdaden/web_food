    ...
    public partial class Cart : System.Web.UI.Page
    {
        ...
        protected void rCartItem_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            if(e.CommandName == "checkout")
            {
                ...
                {
                    lbMsg.Visible = true;
                    lbMsg.Text = "<b>'"+ pName +"' hết mất rồi :(</b>";
                    lbMsg.CssClass = "alert alert-warning";
                }
            }
        }
        ...
        private sealed class CustomTemplate : ITemplate
        {
            ...
            public void InstantiateIn(Control container)
            {
                ...
                {
                    var footer = new LiteralControl("<tr><td colspan='5'><b>Bạn chưa chọn được món à ?</b><a href='Menu.aspx' class='badge badge-info ml-2'>Đi chọn món nào!</a></td></tr></tbody></table>");
